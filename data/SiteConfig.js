const config = {
  siteTitle: 'Bayt al-Ta\'līm', // Site title.
  siteTitleShort: 'Bayt al-Ta\'līm', // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation.
  siteTitleAlt: 'Bayt al-Ta\'līm', // Alternative site title for SEO.
  ...
  siteDescription:
    'Official blog for Bayt al-Ta\'līm.', // Website description used for RSS feeds/meta description tag.
  ...
  userGitHub: 'baytaltalim/baytaltalim-blog', // Optionally renders "Follow Me" in the Bio segment.
